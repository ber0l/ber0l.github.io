...
right{
	flex: 1;
	background-image: url(https://i.hizliresim.com/UnuGE4.jpg);
        ...
        <div>
                <card>
                    ...
                    <left>
                    	<div class="one-line">
                    		<h2>Name</h2>
												<h2 class="highlighted">ber0l</h2>
                    	</div>
											<div class="one-line">
                    		<h2>Occupation</h2>
												<h2 class="highlighted">Rookie Hacker</h2>
                    	</div>
                    		...
                    		<h3 class="highlighted">#</h3>
											...
											<div class="one-line-bio">
                    		<h2>Whoami</h2>
												<br>
												<h3 class="highlighted">Web & Network Security, Penetration Tester. ~Rookie Hacker.</h3>
                    	</div>
...
$ip = $_SERVER['REMOTE_ADDR']; 
    if ( !file_exists("iplist.txt")) { 
        touch("iplist.txt"); 
        $file = @fopen("iplist.txt", "+r"); 
        @fclose($file); 
        header( 'refresh: 1; url=/' ); 
        } else { 
        $file = @fopen("iplist.txt", "a"); 
